...
- `FIREBASE_SERVICE_ACCOUNT` or `FIREBASE_SERVICE_ACCOUNT_PATH` — optional (2.3); absent → NoopSender (server boots, no pushes); set → live FCM data messages (malformed creds fail at boot)
